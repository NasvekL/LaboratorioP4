...
O= main.o IControladorCurso.o IControladorUsuario.o IObserver.o Curso.o Ejercicio.o Estudiante.o Idioma.o Inscripcion.o Leccion.o Profesor.o Progreso.o RellenarPalabras.o Traduccion.o Usuario.o ControladorCurso.o ControladorUsuario.o DTCurso.o DTEjercicio.o DTEstadisticaCurso.o DTEstadisticaEstudiante.o DTEstadisticaProfesor.o DTEstudiante.o DTEstudianteSC.o DTLeccion.o DTNotificacion.o DTProfesor.o DTFecha.o DTProfesorSC.o FactoryController.o 
